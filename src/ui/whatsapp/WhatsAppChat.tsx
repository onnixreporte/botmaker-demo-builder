 ...
 */
export function WhatsAppChat({ profile, items, receipts, typing, online, notice, gallery, onSend, menu = [], clock, prefill }: WhatsAppChatProps) {
  ...
  return (
    <div className="wa-phone">
      <div className="wa-screen" style={{ backgroundImage: `url("${wallpaper}")` }}>
        <div className="wa-sbar" aria-hidden="true">
          ...
          <span className="si">
            <svg width="16" height="12" viewBox="0 0 16 12">
              <path d="M1 11h2V8H1zm4 0h2V6H5zm4 0h2V3H9zm4 0h2V0h-2z" fill="#111B21" />
            </svg>
            <svg width="16" height="12" viewBox="0 0 24 18">
              <path d="M12 18l4-5a6.4 6.4 0 0 0-8 0zm-6.9-8.3 2.2 2.8a7.6 7.6 0 0 1 9.4 0l2.2-2.8a11.2 11.2 0 0 0-13.8 0zM0 3.4l2.2 2.8a15.4 15.4 0 0 1 19.6 0L24 3.4a19 19 0 0 0-24 0z" fill="#111B21" />
            </svg>
            <svg width="24" height="12" viewBox="0 0 24 12">
              <rect x=".5" y=".5" width="20" height="11" rx="3" fill="none" stroke="#111B21" />
              <rect x="2" y="2" width="15" height="8" rx="1.5" fill="#111B21" />
              <rect x="21.5" y="4" width="2" height="4" rx="1" fill="#111B21" />
            </svg>
          </span>
        </div>
        ...
        <div className="wa-homebar" aria-hidden="true">
          <i />
        </div>
